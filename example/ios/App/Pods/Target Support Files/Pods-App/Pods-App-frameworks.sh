...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/MytikiCaptureReceiptCapacitor/MytikiCaptureReceiptCapacitor.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/MytikiTikiSdkCapacitor/MytikiTikiSdkCapacitor.framework"
fi
