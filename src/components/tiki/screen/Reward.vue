...
import CloseIcon from "@/components/tiki/icon/CloseIcon.vue";
import Counter from "@/components/tiki/element/Counter.vue";
import ConfettiExplosion from "vue-confetti-explosion";
import CircleButton from "@/components/tiki/element/CircleButton.vue";
import SquareButton from "@/components/tiki/element/SquareButton.vue";
import AccountIcon from "@/components/tiki/icon/AccountIcon.vue";
import RedeemIcon from "@/components/tiki/icon/RedeemIcon.vue";
