...
export default {
  ...
  // },
  install: (vue: typeof Vue, options: Config.Options): void => {
    const service = new TikiService(options);
    //vue.component("TikiReceipt", TikiReceipt);
    vue.mixin({
      // components: {
      //   "TikiReceipt": TikiReceipt
      // },
      provide: {
        Tiki: service,
      },
...
export { TikiReceipt, TikiService };
export type { Config };
